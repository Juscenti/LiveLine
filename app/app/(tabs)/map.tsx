  ...
  return (
    <View style={styles.container}>
      <MapView
        ...
        initialRegion={{
          latitude: myLocation?.latitude ?? MAP.DEFAULT_LAT,
          longitude: myLocation?.longitude ?? MAP.DEFAULT_LNG,
          latitudeDelta: 0.05,
          longitudeDelta: 0.05,
        }}
      ...
      >
        ...
        {nearbyFriends.map((friend) => (
          <Marker
            ...
            anchor={{ x: 0.5, y: 1 }}
            onPress={() => selectFriend(friend.user_id)}
          >
      ...
      {selectedFriend && (
        <FriendMapSheet friend={selectedFriend} onClose={() => selectFriend(null)} />
      )}
    </View>
  );
}
